 ...
 * Index.js
 */
define("dist/index", [ "./models/ajax", "./models/popbox", "./models/validate", "highcharts" ], function(require) {
    // var $ = require('jquery');
    // window.$ = $;
    var ajax = require("./models/ajax"), popbox = require("./models/popbox"), validate = require("./models/validate");
 ...
 * @Date            2013/03/02
 */
define("dist/models/ajax", [ "./popbox", "./validate" ], function(require, exports, module) {
    var popbox = require("./popbox"), validate = require("./validate");
 ...
 *  @Date           2013/03/02
 */
define("dist/models/popbox", [], function(require, exports, module) {
    //遮罩层
 ...
 * @Date            2013/03/05
 */
define("dist/models/validate", [ "./popbox" ], function(require, exports, module) {
